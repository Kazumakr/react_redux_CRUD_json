...
To management projects. CRUD

## 3.Why did you decide to make this project?

I wanted to learn again. So I decided to make this clone CRUD application.
...
The most challenging part was using Redux(in AddForm, DeleteForm, EditForm component).
